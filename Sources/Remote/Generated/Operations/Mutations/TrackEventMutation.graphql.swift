...
extension ToldAPI {
  class TrackEventMutation: GraphQLMutation {
    ...
    static let operationDocument: Apollo.OperationDocument = .init(
      definition: .init(
        #"mutation TrackEvent($anonymousId: UUID, $name: EventName!, $sourceId: ID!, $primaryData: PrimaryEventDataInput, $preview: Boolean) { addEvent( anonymousID: $anonymousId name: $name sourceID: $sourceId primaryData: $primaryData preview: $preview ) { __typename triggerInfo { __typename activate surveyId activateParam { __typename delay } customizationParam { __typename overlay { __typename active color blur { __typename active number } } } } } }"#
      ))
    ...
    struct Data: ToldAPI.SelectionSet {
      ...
      struct AddEvent: ToldAPI.SelectionSet {
        ...
        static var __parentType: any Apollo.ParentType { ToldAPI.Objects.EventData }
        static var __selections: [Apollo.Selection] { [
        ...
        struct TriggerInfo: ToldAPI.SelectionSet {
          ...
          static var __parentType: any Apollo.ParentType { ToldAPI.Objects.TriggerInfo }
          static var __selections: [Apollo.Selection] { [
            .field("__typename", String.self),
          ...
          struct ActivateParam: ToldAPI.SelectionSet {
            ...
            static var __parentType: any Apollo.ParentType { ToldAPI.Objects.TriggerActivateParam }
            static var __selections: [Apollo.Selection] { [
              .field("__typename", String.self),
          ...
          struct CustomizationParam: ToldAPI.SelectionSet {
            ...
            static var __parentType: any Apollo.ParentType { ToldAPI.Objects.TriggerCustomizationParam }
            static var __selections: [Apollo.Selection] { [
              .field("__typename", String.self),
            ...
            struct Overlay: ToldAPI.SelectionSet {
              ...
              static var __parentType: any Apollo.ParentType { ToldAPI.Objects.SurveyOverlay }
              static var __selections: [Apollo.Selection] { [
                .field("__typename", String.self),
              ...
              struct Blur: ToldAPI.SelectionSet {
                ...
                static var __parentType: any Apollo.ParentType { ToldAPI.Objects.SurveyOverlayBlur }
                static var __selections: [Apollo.Selection] { [
                  .field("__typename", String.self),
                  .field("active", Bool?.self),
